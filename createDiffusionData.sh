...
./DWIConvert --inputVolume ${DTI_DIR}/${SUBJECT}_42_DWI*_QCed_VC_Upx2.nrrd --conversionMode NrrdToFSL --outputVolume ${SUBJECT_DIR}/Diffusion/data.nii.gz --outputBVectors ${SUBJECT_DIR}/Diffusion/bvecs --outputBValues ${SUBJECT_DIR}/Diffusion/bvals
echo "Done !"
