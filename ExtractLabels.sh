...
$toolDIR/ExtractLabelSurfaces --extractPointData --translateToLabelNumber --labelNameInfo labelListName.txt --labelNumberInfo  labelListNumber.txt --useTranslationTable --labelTranslationTable ${SUBJECT_DIR}/RGBToLabelTranslation.txt -a colour --vtkLabelFile ${DTI_DIR}/${SUBJECT}_combined_MiddleSurf_AALCOLOR.vtk --createSurfaceLabelFiles --vtkFile ${DTI_DIR}/${SUBJECT}_combined_InnerSurf.vtk ${overlapFlag}
